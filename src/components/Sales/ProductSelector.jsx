          ...
          <button
            ...
            className={`w-full text-left p-4 rounded-xl transition-all duration-200 group ${
              selected?.id === product.id
                ? 'bg-blue-500/10 border border-blue-500/30 shadow-glow'
                : 'bg-white/5 border border-transparent hover:bg-white/10 hover:border-white/10'
            }`}
          >
            <div className="flex justify-between items-start">
              <div className="flex-1">
                <span className="text-white font-medium group-hover:text-cyan-400 transition-colors">{product.name}</span>
              ...
              <div className="flex items-center space-x-2">
                <span className="text-green-400 font-bold text-lg">${product.costUSD}</span>
