  ...
  return (
    ...
    >
      <motion.div
        ...
        className="glass-card w-full max-w-sm md:max-w-md p-6 md:p-8 space-y-5"
      >
        <div className="text-center">
          <h3 className="text-xl md:text-2xl font-bold">Emitir comprobante</h3>
          <p className="text-base text-text-secondary mt-2">
            Venta por <strong>${sale.totalUSD.toFixed(2)}</strong> registrada.
          </p>
          <p className="text-sm text-text-muted mt-1">Debe seleccionar un tipo de documento:</p>
        </div>
        ...
        <div className="space-y-3">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-between p-5 rounded-xl bg-surface/40 border border-border hover:border-primary transition disabled:opacity-50"
          >
            <div className="flex items-center gap-4">
              <Receipt size={28} className="text-primary" />
              <div className="text-left">
                <p className="font-bold text-lg">Recibo simplificado</p>
                <p className="text-sm text-text-muted">Solo en dólares, sin IVA</p>
              </div>
            </div>
          </button>
          <button
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-text-muted">En bolívares, con IVA desglosado</p>
              </div>
            </div>
          </button>
        </div>

        <p className="text-sm text-text-muted text-center">Elija una opción para continuar.</p>
      </motion.div>
    </motion.div>
  );
}