  ...
  return (
    <div className="glass-card rounded-2xl p-6 animate-fade-in">
      ...
      <div className="space-y-4">
        ...
        <button className="w-full py-4 bg-gradient-to-r from-accent-green to-emerald-600 hover:from-emerald-500 hover:to-emerald-700 rounded-xl text-white font-bold text-lg transition-all shadow-lg hover:shadow-glow flex items-center justify-center space-x-2">
          <DollarSign size={20} />
